...
```{r, results='markup', echo=FALSE, out.width="49%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
```{r, results='markup', echo=FALSE, out.width="25%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
```{r, results='markup', echo=FALSE, out.width="20%", out.height="30%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
***
```{r no_of_jobs, results='markup', echo=FALSE, out.width="35%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
```{r, results='markup', echo=FALSE, out.width="35%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
```{r, results='markup',warning=FALSE, echo=FALSE, out.width="35%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
```{r, results='markup', echo=FALSE, out.width="50%", out.height="25%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
The following is a box-plot for the same variable.
...
```
***
From the box-plot, we can see that, though the boxes lie around the same region, few of the classes have very evident difference. This needs to be checked. Whether food security score affects the hours on job can be studied using ANOVA test and our hypothesis is verified by this statistical test.
...
```{r, results='hide', echo=FALSE, out.width="35%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center'}
...
### Future Scope
The results from the study also shows that further analysis can come up with models to predict the food security score and hence it reveals the important sectors that officials should focus on in order to eradicate food insecurity.   
The initial results shows that 10% of the population are still food insecure in the USA, which accounts for about 33 million people. Food being the vary basic need of any living being, all should have access to safe and proper food. This signifies the result of the study and the further need of studies. We hope that high quality data and thorough analysis will help to eradicate world hunger. 
...
•	https://www.tutorialspoint.com/r/r_mean_median_mode.html

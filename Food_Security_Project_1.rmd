...
state1<-subset(FS_Subset, FoodSecurity_score=="Very Low Food Security")
state1
state2<-subset(FS_Subset, FoodSecurity_score=="Low Food Security")
state2
state3<-subset(FS_Subset, FoodSecurity_score=="Marginal Food Security")
state3
state4<-subset(FS_Subset, FoodSecurity_score=="High Food Security")
state4
...
```{r, results='markup'}
summary(food_una$Household_Income)
```
